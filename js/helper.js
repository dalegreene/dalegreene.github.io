...
var HTMLskills = '<ol class="flex-item"><span class="white-text">%data%</span></ol>';
...
var HTMLprojectImage = '<img src="%data%" max width=300px>';
...
// Custom Google Map generation for the website.
...
function initializeMap() {
  ...
  function createMapMarker(placeData) {
    ...
    // helper windows that open when you click or hover over a pin on a map
    ...
    // where the pin gets added to the map.
  ...
  // takes in the array of locations created by locationFinder() and fires off Google place searches for each location
